                    ...
                    <form method="post" action="/login">
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <button type="submit" class="btn btn-primary btn-lg"
                                    style="padding-left: 2.5rem; padding-right: 2.5rem;">Ввійти
                            </button>
                            <p class="small fw-bold mt-2 pt-1 mb-0">Ще не зареєтровані? <a href="/register"
                                                                                           class="link-danger">Зареєструватися</a>
                            </p>
                        </div>
                    </form>
                </div>
