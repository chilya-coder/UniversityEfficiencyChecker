<%@ page import="com.chimyrys.universityefficiencychecker.db.DepartmentRepository" %>
<%@ page import="com.chimyrys.universityefficiencychecker.model.Department" %>
<%@ page import="java.util.List" %>
<%@ page import="com.chimyrys.universityefficiencychecker.model.Position" %>
<%@ page import="com.chimyrys.universityefficiencychecker.db.PositionRepository" %>
